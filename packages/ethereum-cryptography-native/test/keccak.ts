...
import * as keccakModuleType from "../src/keccak";

try {
  const keccakModule = require("../src/keccak");

  const keccak224: typeof keccakModuleType.keccak224 = keccakModule.keccak224;
  const keccak256: typeof keccakModuleType.keccak256 = keccakModule.keccak256;
  const keccak384: typeof keccakModuleType.keccak384 = keccakModule.keccak384;
  const keccak512: typeof keccakModuleType.keccak512 = keccakModule.keccak512;
